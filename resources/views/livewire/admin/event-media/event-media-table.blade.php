<div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                @if ($form['file_type'] === 'image')
                    <div class="md:col-span-2">
                        ...
                        @elseif ($currentFilePath && $form['file_type'] === 'image')
                            <img src="{{ \App\Support\PublicMedia::url($currentFilePath) }}" alt="{{ __('mma.admin.event_media.form.media_image') }}" class="mt-2 h-40 w-full rounded border border-gray-200 object-cover dark:border-gray-700">
                        @endif
    ...
    @if ($showDeleteModal)
        <x-tw-confirm-modal
            ...
            confirm="delete"
            :title="__('mma.admin.event_media.delete_title')"
            :message="__('mma.admin.event_media.delete_warning')"
