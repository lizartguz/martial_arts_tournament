...
$en['admin']['ticket_links'] = [
    ...
    'table_subtitle' => 'Filtra, crea, edita o elimina enlaces p?blicos de venta asociados a eventos.',
    'create' => 'Nuevo enlace',
    'edit' => 'Editar enlace',
...
$en['subscriber_portal'] = [
    ...
    'actions' => ['view_all' => 'Ver todo', 'save' => 'Guardar cambios'],
    ...
    'purchases' => ['title' => 'Mis compras', 'subtitle' => 'Revisa pagos y solicitudes registradas para tu cuenta.', 'payments' => 'Pagos', 'requests' => 'Solicitudes'],
    'subscription' => ['title' => 'Mi suscripción', 'subtitle' => 'Revisa tu plan actual y el historial de suscripciones.', 'current' => 'Suscripción actual', 'history' => 'Historial de suscripciones'],
    'profile' => ['title' => 'Perfil', 'subtitle' => 'Actualiza tus propios datos de contacto.', 'updated' => 'Perfil actualizado correctamente.', 'form' => ['name' => 'Nombre', 'lastname' => 'Apellido', 'email' => 'Correo', 'number_phone' => 'Teléfono', 'identity_document' => 'Documento de identidad']],
