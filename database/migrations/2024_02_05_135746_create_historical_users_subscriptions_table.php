...
return new class extends Migration
{
    ...
    {
        Schema::create('historical_users_subscriptions', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('amount')->nullable()->comment('cantidad de suscripciones');
            $table->boolean('is_discount')->nullable();
            $table->integer('added_user_count')->nullable();
            $table->decimal('added_user_total_cost')->nullable();
            $table->decimal('cost')->nullable()->comment('costo de la suscripción');
    ...
    {
        Schema::dropIfExists('historical_users_subscriptions');
    }
};
