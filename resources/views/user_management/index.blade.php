...
@section('content')
    ...
    <div>
        <livewire:user_management.user-management />
    </div>
...
<script>
        function messageWithStation(){
          ...
          b.checked = false;
          Swal.fire({
                title: '<h5>'+ 'Para habilitar la opción: "Con estación", debe seleccionar una estación de la lista.' +'</h5>',              
        ...
        async function initMap(type,lat,lng,zoom) { 
            ...
            const marker = new AdvancedMarkerElement({ position: myLatlng,title:'Marcador',});
            array[0] = marker;  
            array[0].setMap(map);
    ...
    <script>
        ...
        window.deleteStationManager = function (data) {  
            ...
            Swal.fire({
                title: `<h5>¿Está seguro que desea desvincular la estación?</h5>`,
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
        ...
        window.changeStationManager = function (data) {  
            ...
            Swal.fire({
                title: `<h5>¿Está seguro que desea cambiar la vinculación de la estación?</h5>`,
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    ...
                    if (!stationName.trim()) {
                        Swal.fire({
                            title: `<h5>Debe seleccionar una estación para cambiar la vinculación</h5>`,
        ...
        window.addStationManager = function (data) {  
            ...
            Swal.fire({
                title: `<h5>¿Está seguro que desea vincular la estación?</h5>`,
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    ...
                    if (!stationName.trim()) {
                        Swal.fire({
                            title: `<h5>Debe seleccionar una estación para la vinculación</h5>`,
                            confirmButtonColor: '#7A0D0DF6',                                
                            confirmButtonText: `Ok`,
                        });
                    } else {
        ...
        window.changeStationE  = function () {
            Swal.fire({
                title: `<h5>¿Está seguro que desea cambiar la estación?</h5>`,
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: `Si, vincular`,
                ...
                if (result.isConfirmed) {
                    ...
                    if (!stationName.trim()) {
                        Swal.fire({
                            title: `<h5>Debe seleccionar una estación para la nueva vinculación</h5>`,
                            confirmButtonColor: '#7A0D0DF6',                                
                            confirmButtonText: `Ok`,
                        });
                    } else {
        ...
        function resetDevice(id){          
            Swal.fire({
                title: `<h5>¿Está seguro que desea cambiar el <strong>identificador del dispositivo</strong> ?</h5>`,
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: `Si, eliminar`,
        ...
        function changeStatusUser(actualState,userId,position,type){   
            ...
            Swal.fire({
                title: `<h5>¿Está seguro que desea cambiar el <strong>estado</strong> al usuario ?</h5>`,
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
