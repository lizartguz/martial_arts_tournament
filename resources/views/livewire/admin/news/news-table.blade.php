<div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <td>
                            <div class="flex justify-center" x-data="{ open: false }" @click.outside="open = false">
                                ...
                                <div x-show="open" x-cloak
                                     class="absolute z-20 mt-8 w-44 rounded border border-gray-200 bg-white py-1 shadow-lg dark:border-gray-700 dark:bg-gray-800">
                                    @can('news.update')
            ...
            <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
                ...
                <div>
                    ...
                    @elseif ($currentCoverImage)
                        <img src="{{ asset($currentCoverImage) }}" alt="{{ __('mma.admin.news.form.cover_image') }}" class="mt-2 h-44 w-full rounded border border-gray-200 object-cover dark:border-gray-700">
                    @endif
    ...
    @if ($showDeleteModal)
        <x-tw-modal close="closeDeleteModal" max-width="md" :title="__('mma.admin.news.delete_title')" icon="fas fa-trash" header-class="bg-red-600 text-white">
            <p class="text-sm text-gray-700 dark:text-gray-300">
                {{ __('mma.admin.news.delete_warning') }} <strong>{{ $deleteName }}</strong>
            </p>
            <x-slot:footer>
