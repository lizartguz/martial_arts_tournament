...
<head>
    ...
    <title>Reporte de Historico de Mantenimiento</title>
    <style>
...
<body>
    <header>
        <div class="row-one">
            <div class="logo-reporte">
                <img src="{{ public_path('imgpf/logo_artguz.jpeg') }}" alt="profe_logo">
            </div>
    ...
    <div class="body">
    <p style="text-align: center;font-size: 14pt;font-weight: bold;">Historial de Mantenimiento</p>
    <p style="text-align: left;font-size: 12pt;font-weight: bold;"><span style="font-size: 12pt;font-weight: bold;">ESTACIÓN: </span><span style="font-size: 12pt;color:rgb(27, 74, 169);">{{$dataResponse[0]->station->name}} </span></p>    
    <table>
            <thead>
                <tr>                   
                    ...
                    <th scope="col" style="font-size: 8pt">Mantto.</th>
                    <th scope="col" style="font-size: 8pt">Descripción</th> 
                    <th scope="col" style="font-size: 8pt">Recomendaciones</th>  
                    <th scope="col" style="font-size: 8pt">Tipos de mantto.</th>    
                </tr>
            </thead>
            <tbody>
                @if(count($dataResponse)>0)
                    ...
                    <tr>                        
                        ...
                        <td>
                            <p>registrado: {{$item->maintenance_date}}</p>
                            <p>Próximo: {{$item->next_maintenance_date}}</p>
                        </td>
                        <td>{{$item->description}}</td>
                        <td>{{$item->recommendations}}</td>     
                        <td style="margin-top:0;">
                            <p>Preventivo: {{$item->preventive_maintenance}}</p>
                            <p>Correctivo: {{$item->corrective_maintenance}}</p>
                        </td>
